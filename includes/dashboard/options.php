...
class BookingHub_Settings {
	...
	function settings_init() : void {
		...
		register_setting( 'bookinghub-settings', 'wporg_options' );


		// Register a new section.
		add_settings_section(
			'bookinghub-settings-section',
			__( 'Section Description', 'booking-hub' ),
			[$this, 'render_section'],
			'bookinghub-settings'
		);
		...
		foreach( $this->fields as $field ) {
			...
			add_settings_field(
				...
				__( $field['label'], 'booking-hub' ), /* Label for the field. */
				[$this, 'render_field'], /* The name of the callback function. */
				'bookinghub-settings', /* The menu page on which to display this field. */
				'bookinghub-settings-section', /* The section of the settings page in which to show the box. */
				[
	...
	function options_page() : void {
		add_submenu_page(
			'edit.php?post_type=bhub-booking', /* Parent Menu Slug */
			'Settings', /* Page Title */
			'Settings Page', /* Menu Title */
			$this->capability, /* Capability */
			'bookinghub-settings', /* Menu Slug */
	...
	function render_options_page() : void {
		...
		if ( isset( $_GET['settings-updated'] ) ) {
			...
			add_settings_error( 'wporg_messages', 'wporg_message', __( 'Settings Saved', 'booking-hub' ), 'updated' );
		}
		...
		<div class="wrap">
			...
			<h2 class="description">Page Desct</h2>
			<form action="options.php" method="post">
				<?php
				/* output security fields for the registered setting "wporg" */
				settings_fields( 'bookinghub-settings' );
				/* output setting sections and their fields */
				/* (sections are registered for "wporg", each field is registered to a specific section) */
				do_settings_sections( 'bookinghub-settings' );
	...
	function render_section( array $args ) : void {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>"><?php esc_html_e( 'Section Title', 'booking-hub' ); ?></p>
		<?php
	}

}

new BookingHub_Settings();
